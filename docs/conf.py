...
html_extra_path = [
    ...
    '__project-web-story-structure/21-cover-page/_example/cover.html',
    ...
    '__project-web-story-structure/31-background-text-color-shadow/_example/image/mental-models-w936-h576.png',
    '__project-web-story-structure/31-background-text-color-shadow/_example/image/philip-johnson-laird-w512-h512.jpg',
...
today_fmt = '%y-%m-%d'
html_last_updated_fmt = '%y-%m-%d at %H:%M offset -05:00'
